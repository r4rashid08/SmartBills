...
public class InvoiceFragment extends Fragment {
    ...
    String type = "";
    public InvoiceFragment(String localTYpe) {
        type = localTYpe;
    }
    @Override
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        // add your fragments
        adapter.addFrag(new PendingOrderFragment(type));
        adapter.addFrag(new CompletedOrderFragment(type));
        adapter.addFrag(new CanceledOrderFragment(type));
